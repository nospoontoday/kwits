                ...
                <>
                    ...
                    >
                        <Popover.Panel className="absolute right-0 z-10 mt-3 w-[300px] px-4 sm:px-0">
                            <div className="overflow-hidden ronded-lg shadow-lg ring-1 ring-black/5">
                                <div className="bg-gray-800 p-4">
                                    ...
                                    {!description && (
                                        <div className="text-xs text-gray-500 text-center py-4">No description is defined.</div>
                                    )}
                                </div>
                            </div>
                        </Popover.Panel>
